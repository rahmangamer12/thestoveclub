    ...
    <div className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="overflow-hidden mb-6">
          ...
          >
            {restaurant.name.toUpperCase().split(' ').map((word, i, arr) => (
              <span key={i}>
                {i === arr.length - 1 ? <span className="text-[#D4AF37] drop-shadow-[0_0_20px_rgba(212,175,55,0.4)]">{word}</span> : word + ' '}
              </span>
            ))}
          </motion.h1>
        </div>
        ...
        >
          {restaurant.hours} &bull; {restaurant.services.join(', ')}
        </motion.p>
