          ...
          >
            ...
            {restaurant.instagram ? (
              ...
              >
                ...
                Follow @{restaurant.instagram.split('/').filter(Boolean).pop()}
              </a>
            ) : restaurant.whatsapp && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 border border-[#25D366] text-[#25D366] font-semibold rounded-xl hover:bg-[#25D366] hover:text-white transition-all duration-300 uppercase tracking-widest group"
              >
                <svg
                  className="w-5 h-5 group-hover:scale-110 transition-transform duration-300"
                  fill="currentColor"
